...
# Категория, где Ticket Tool создаёт заявки
...
# Фраза-триггер (Ticket Tool пишет это при попытке закрыть заявку)
TRIGGER_PHRASE = "вы серьезно хотите закрыть данную заявку"
...
INVITE_LINK = "https://discord.gg/shclan"
...
# Если указан ID сообщения бота — бот будет редактировать именно его и вешать на него кнопку формы.
PRIVATE_SETUP_TARGET_MESSAGE_ID = 1498759605784674346
...
# -------------------- ROLE SYNC (PUBLIC <-> PRIVATE) --------------------
PUBLIC_GUILD_ID = 1287197183954784296
PRIVATE_GUILD_ID = 1454836789331230842

PUBLIC_ROLE_SH_ID = 1299444337658171422
PUBLIC_ROLE_FUN_SH_ID = 1315028367044513876
PRIVATE_ROLE_SH_ID = 1454842309421170719

# Резервный текст, если embed по какой-то причине не получится отправить/обновить.
PRIVATE_SETUP_MESSAGE = (
    "**Приватка: установка ника**\n"
    "Нажми кнопку ниже и заполни форму. Бот автоматически поставит ник по формату "
...
# -------------------- CHANNEL ORDER PROTECTION --------------------
# Серверы, за которыми следит защита, и каналы логов для каждого сервера.
PROTECTED_GUILD_LOG_CHANNELS: dict[int, int] = {
    1287197183954784296: 1466163549150773363,
    1454836789331230842: 1485342858448867359,
}

# Кого пинговать в логах защиты каналов. Сейчас стоит тот же ID, которому разрешены админ-команды.
PROTECT_PING_USER_ID = 1105559182624694393
