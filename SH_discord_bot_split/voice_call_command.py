...
Бот отправляет в текущий канал сообщение:
<@user>, вас вызывает модератор на обзвон. Перейдите, пожалуйста, в канал ожидание проверки.
"""
